...
1) 语法差异: JSX vs Templates

在 React 中，所有的组件的渲染功能都依靠 JSX, JSX语法的优势:
...
相对于JSX语法,Vue的templates语法对于开发者来说更易上手
...
3) vue推荐的是使用 webpack + vue-loader 的单文件组件格式，React 推荐的做法是 JSX + inline style
